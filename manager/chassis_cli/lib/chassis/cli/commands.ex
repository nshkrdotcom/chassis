...
defmodule Chassis.CLI.Command.Model.Materialize do
  @moduledoc "Runs the Phase 38 target-host model weight materializer."
  @behaviour Chassis.CLI.Command
  ...
  def run(positional, switches) do
    ...
    cond do
      ...
      true ->
        expected_digest = Manifest.fixture_digest(model_ref)
...
defmodule Chassis.CLI.Command.Tensor.Rollback do
  @moduledoc "Runs the Phase 40 tensor patch rollback lifecycle."
  @behaviour Chassis.CLI.Command
